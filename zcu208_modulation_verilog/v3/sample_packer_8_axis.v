...
//
// Nathan Weng 08/2026
// Multi-Modulation IQ Sample Packer AXIS
// 
// Input @ 160 MHz:
...
module sample_packer_8_axis #(
   ...
   initial begin
        ...
        $display("XXXXXX SAMPLE_PACKER COMPLEX_WIDTH                    = %d", COMPLEX_WIDTH);
        $display("XXXXXX SAMPLE_PACKER COMPLEX_SAMPLES_PER_WORD        = %d", COMPLEX_SAMPLES_PER_WORD);
