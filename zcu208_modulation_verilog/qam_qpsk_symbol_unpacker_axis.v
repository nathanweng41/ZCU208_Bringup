...
module qam_qpsk_symbol_unpacker_axis (        
     ...
     input wire mod_mode // 0 = QPSK, 1 = QAM
   ...
   localparam integer BITS_PER_SYMBOL;
   assign BITS_PER_SYMBOL = mod_mode ? 4 : 2;
...
initial begin
    $display("*****************************************************");
    $display("XXXXXX QAM_QPSK_SYMBOL_UNPACKER IN_WIDTH                       = %d", IN_WIDTH);
    $display("XXXXXX QAM_QPSK_SYMBOL_UNPACKER BITS_PER_SYMBOL                = %d", BITS_PER_SYMBOL);
    $display("XXXXXX QAM_QPSK_SYMBOL_UNPACKER SYMBOLS_PER_WORD               = %d", SYMBOLS_PER_WORD);
	$display("XXXXXX QAM_QPSK_SYMBOL_UNPACKER IDX_WIDTH						= %d", IDX_WIDTH);
end
